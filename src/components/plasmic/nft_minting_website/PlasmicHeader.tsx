...
import sty from "./PlasmicHeader.module.css"; // plasmic-import: kHpfvMoPjbW5/css

import HomeSvgIcon from "./icons/PlasmicIcon__HomeSvg"; // plasmic-import: WOkGmtYqJTzk/icon
...
const PlasmicDescendants = {
  root: ["root", "freeBox", "svg", "text", "connectWalletButton"],
